...
class SimpleController(object):
    ...
    def get_control(self, obs, temp_sp, month, hour=0):
        """Computes the control actions.
        ...
        if self.env_name == 'OfficesThermostat-v0':
            if (month <=5) or (month >= 11):
                controls['Bd_Heating_onoff_sp'] = [1]
                controls['Bd_Cooling_onoff_sp'] = [0]
            elif (month > 5) and (month <= 10):
                controls['Bd_Heating_onoff_sp'] = [0]
                controls['Bd_Cooling_onoff_sp'] = [1]
...
class LabController(object):
    ...
    def get_control(self, obs, temp_sp, month, hour):
        """Computes the control actions.
        ...
        for measurement in self.observations:
            ...
            if (
                ...
                for control in self.HP_temp_controls:
                    controls[control] = [55]
            controls[control_name][0] = control_temp
        controls['Bd_Ch_EV1Bat_sp'] = [0.0]
        controls['Bd_Ch_EV2Bat_sp'] = [0.0]
